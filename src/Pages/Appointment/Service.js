  ...
  return (
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body">
        <h2 className="card-title flex justify-center text-secondary text-2xl">{name}</h2>
        <p>
          {slots.length > 0 ? (
        ...
        <div className="card-actions pt-5 flex justify-center">
          <button
            ...
            className="btn text-white bg-gradient-to-r from-secondary to-primary text-lg"
          >
            Book Now
          </button>
        </div>
